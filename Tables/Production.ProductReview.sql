...
[PhoneticComments] [nvarchar] (3850) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
...
GO
ALTER FULLTEXT INDEX ON [Production].[ProductReview] ADD ([PhoneticComments] LANGUAGE 1033)
GO
